...
class Angle {
    private:
        double theta;
        static const double M_2PI;  // For efficiency
    ...
    public:
        ...
        double alDiff(const Angle &other);  
        ...
        double ccwDiff(const Angle &other);
        ...
        double cwDiff(const Angle &other);
        ...
        bool almostEqual(Angle A, double toll);
        ...
        Angle nearestMean(const Angle &other, double w1 = 0.5);
        ...
        Angle ccwMean(const Angle &other);
...
class Pose {
    public:
        ...
        /// \brief Print.
        std::string print(int linPrecision=4,int angPrecision=2);
